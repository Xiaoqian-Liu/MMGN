function [U, V, rhat, err, outs] = GD_probit_auto(Y, ind_omega, sigma, M, opts)
...
%% Set algorithm parameters from input or by using defaults.
    ...
    for k = 1:numR
        ...
        [U, V, relerr] = GD_probit(Y, ind_train, sigma, U0, V0, M, 'maxiters',maxiters, 'tol',tol,...
    ...
    [U, V, relerr, relchange, obj] = GD_probit(Y, ind_omega, sigma, U00, V00, M, 'maxiters',maxiters, 'tol',tol,...
                                                'stopping',stopping, 'alpha0', alpha0);
