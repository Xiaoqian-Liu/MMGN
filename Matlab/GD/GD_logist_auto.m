function [U, V, rhat, err, outs] = GD_logist_auto(Y, ind_omega, sigma, M, opts)
% This function implements GD for 1-bit matrix completion under the logistic
...
%       opts includes the following parameters
        ...
        % alpha0: the initial stepszie of GD for backtracking linesearch (default: 1)
...
%% main loop to select r
    for k = 1:numR
        ...
        [U, V, relerr] = GD_logist(Y, ind_train, sigma, U0, V0, M, 'maxiters',maxiters, 'tol',tol,...
    ...
    [U, V, relerr, relchange, obj] = GD_logist(Y, ind_omega, sigma, U00, V00, M,'maxiters',maxiters, 'tol',tol,...
                                                             'stopping',stopping, 'alpha0', alpha0);
